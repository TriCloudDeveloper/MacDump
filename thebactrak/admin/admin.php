<?php include_once('../include_common.php'); session_start();
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
           <li style="background: #4d5256;" class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
        ...
        <div class="col-xl-6 col-sm-6 mb-3">
          <div class="card text-white bg-warning o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5"><?php echo $num_rows; ?> New Users!</div>
            </div>
       ...
       <div class="col-xl-6 col-sm-6 mb-3">
          <div class="card text-white bg-success o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">Password Change!</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="change_pwd.php">
              <span class="float-left">Click Here</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
